...
| **Listing visibility** | Only `status = 'active'` businesses are returned by search, SEO lists, and lead routing — an inactive/closed listing is never surfaced. | `db/migrations/0001,0003`, `lib/queries.ts`, `lib/leads.ts` |
